pipeline{
        ...
        stages{
            ...
            stage('Deploy Application'){
                steps{
                    sh "sudo docker-compose pull -f chaperootodo_client/docker-compose.yaml && sudo -E DB_PASSWORD=\${DB_PASSWORD} docker-compose up -d -f chaperootodo_client/docker-compose.yaml"
                }
            }
        }
}